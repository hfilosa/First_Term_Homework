...
public class Driver{
	...
	if (classtype.toLowerCase.equals("mage"))
			 {mage player = new mage(name);}
	/*if (classtype.toLowerCase.equals("rogue"))
			 {rogue player = new rogue(name);}
	if (classtype.toLowerCase.equals("warrior"))
	{warrior player = new warrior (name);}*/


	//Now we create the monster
=======
import java.util.*;
public class Driver {
    public static void main(String[] args){
